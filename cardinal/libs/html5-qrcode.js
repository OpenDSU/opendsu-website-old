function getLazarSoftScanner(container) {
  var e = {};
  ...
  function r(e, t, n, r, i, a) {
    ...
    this.totalCodewords = o, this.__defineGetter__("VersionNumber", function () {
      ...
      for (var n = this.alignmentPatternCenters.length, r = 0; r < n; r++) for (var i = this.alignmentPatternCenters[r] - 2, a = 0; a < n; a++) 0 == r && (0 == a || a == n - 1) || r == n - 1 && 0 == a || t.setRegion(this.alignmentPatternCenters[a] - 2, i, 5, 5);
  ...
  function o(t) {
    this.image = t, this.resultPointCallback = null, this.sizeOfBlackWhiteBlackRun = function (e, t, n, r) {
      ...
      if (o < 1) throw"Error";
      var s = this.computeDimension(t, n, i, o), h = r.getProvisionalVersionForDimension(s),
        w = h.DimensionForVersion - 7, f = null;
      if (h.AlignmentPatternCenters.length > 0) for (var u = n.X - t.X + i.X, d = n.Y - t.Y + i.Y, l = 1 - 3 / w, c = Math.floor(t.X + l * (u - t.X)), g = Math.floor(t.Y + l * (d - t.Y)), v = 4; v <= 16; v <<= 1) {
  ...
  e.checkAndNudgePoints = function (e, t) {
    ...
    var u = n - a, d = s - a, l = e - n + a - s, c = r - o, g = u * w - d * c, v = (l * w - d * f) / g,
      m = (u * f - l * c) / g;
  ...
  function b(e) {
    ...
    this.bitMatrix = e, this.parsedVersion = null, this.parsedFormatInfo = null, this.copyBit = function (e, t, n) {
      ...
      var e = this.readFormatInformation(), t = this.readVersion(), n = y.forReference(e.DataMask),
  ...
  function C(e, t) {
    ...
    this.__defineGetter__("Zero", function () {
      ...
      for (var t = this.coefficients, n = t.length, r = e.coefficients, i = r.length, a = new Array(n + i - 1), o = 0; o < n; o++) for (var s = t[o], h = 0; h < i; h++) a[o + h] = _.addOrSubtract(a[o + h], this.field.multiply(s, r[h]));
      ...
      for (var t = this.field.Zero, n = this, r = e.getCoefficient(e.Degree), i = this.field.inverse(r); n.Degree >= e.Degree && !n.Zero;) {
        var a = n.Degree - e.Degree, o = this.field.multiply(n.getCoefficient(n.Degree), i),
          s = e.multiplyByMonomial(a, o), h = this.field.buildMonomial(a, o);
  ...
  p.rsDecoder = new function (e) {
    this.field = e, this.decode = function (e, t) {
      ...
      if (!a) {
        var s = new C(this.field, r), h = this.runEuclideanAlgorithm(this.field.buildMonomial(t, 1), s, t), w = h[0],
          f = h[1], u = this.findErrorLocations(w), d = this.findErrorMagnitudes(f, u, !1);
  ...
  A.imagedata = null, A.width = 0, A.height = 0, A.qrCodeSymbol = null, A.debug = !1, A.maxImgSize = 1048576, A.sizeOfDataLengthInfo = [[10, 9, 8, 8], [12, 11, 16, 10], [14, 13, 16, 12]], A.callback = null, A.vidSuccess = function (e) {
    ...
    var t = navigator;
    A.video = container.querySelector("#"+e);
    var n = !0;
    ...
    if (0 == arguments.length) {
      if (A.canvas_qr2) var t = A.canvas_qr2,
        n = A.qrcontext2; else n = (t = container.querySelector("#qr-canvas")).getContext("2d");
    ...
    r.crossOrigin = "Anonymous", r.onload = function () {
      var e = container.querySelector("#"+"out-canvas");
      if (null != e) {
    ...
    if (A.debug) {
      for (var r = 0; r < A.height; r++) for (var i = 0; i < A.width; i++) {
    ...
    if (A.debug) {
      for (r = 0; r < s.bits.Height; r++) for (i = 0; i < s.bits.Width; i++) {
    ...
    for (var t = new Array(A.width * A.height), n = 0; n < A.height; n++) for (var r = 0; r < A.width; r++) {
    ...
    for (var o = 0; o < 4; o++) for (var s = 0; s < 4; s++) {
      r[s][o][0] = 255;
      for (var h = 0; h < n; h++) for (var w = 0; w < t; w++) {
    ...
    for (var t = A.getMiddleBrightnessPerArea(e), n = t.length, r = Math.floor(A.width / n), i = Math.floor(A.height / n), a = new ArrayBuffer(A.width * A.height), o = new Uint8Array(a), s = 0; s < n; s++) for (var h = 0; h < n; h++) for (var w = 0; w < i; w++) for (var f = 0; f < r; f++) o[r * h + f + (i * s + w) * A.width] = e[r * h + f + (i * s + w) * A.width] < t[h][s];
    return o
  }, A.grayscale = function () {
    for (var e = new ArrayBuffer(A.width * A.height), t = new Uint8Array(e), n = 0; n < A.height; n++) for (var r = 0; r < A.width; r++) {
      var i = A.getPixel(r, n);
      t[r + n * A.width] = i
    }
    return t
  ...
  function D() {
    this.image = null, this.possibleCenters = [], this.hasSkipped = !1, this.crossCheckStateCount = new Array(0, 0, 0, 0, 0), this.resultPointCallback = null, this.__defineGetter__("CrossCheckStateCount", function () {
      ...
      var r = e[0] + e[1] + e[2] + e[3] + e[4], i = this.centerFromEnd(e, n),
      ...
      for (var i = !1, a = new Array(5), o = r - 1; o < t && !i; o += r) {
        ...
        for (var s = 0, h = 0; h < n; h++) if (e[h + o * A.width]) 1 == (1 & s) && s++, a[s]++; else if (0 == (1 & s)) if (4 == s) if (this.foundPatternCross(a)) {
          if (this.handlePossibleCenter(a, o, h)) if (r = 2, this.hasSkipped) i = this.haveMultiplyConfirmedCenters(); else {
        ...
        } else a[0] = a[2], a[1] = a[3], a[2] = a[4], a[3] = 1, a[4] = 0, s = 3; else a[++s]++; else a[s]++;
  ...
  function F(e, t, n, r, i, a, o) {
    this.image = e, this.possibleCenters = new Array, this.startX = t, this.startY = n, this.width = r, this.height = i, this.moduleSize = a, this.crossCheckStateCount = new Array(0, 0, 0), this.resultPointCallback = o, this.centerFromEnd = function (e, t) {
      ...
      var r = e[0] + e[1] + e[2], i = this.centerFromEnd(e, n),
  ...
  function I(e, t, n) {
    this.blockPointer = 0, this.bitPointer = 7, this.dataLength = 0, this.blocks = e, this.numErrorCorrectionCode = n, t <= 9 ? this.dataLengthMode = 0 : t >= 10 && t <= 26 ? this.dataLengthMode = 1 : t >= 27 && t <= 40 && (this.dataLengthMode = 2), this.getNextBits = function (e) {
      ...
      for (var e = new Array; ;) {
        ...
        if (7 == t) var n = this.parseECIValue(); else {
...
var Html5Qrcode = /*#__PURE__*/function () {
   ...
   */
  function Html5Qrcode(container, elementId, verbose) {
    ...
    this.qrcode = getLazarSoftScanner(container);
  ...
  _createClass(Html5Qrcode, [{
    ...
    value: function start(cameraId, configuration, qrCodeSuccessCallback, qrCodeErrorCallback) {
      ...
      var element = this._container.querySelector("#"+this._elementId);
...
var Html5QrcodeScanner = /*#__PURE__*/function () {
   ...
   *                  would be printed to console.
   */
  function Html5QrcodeScanner(container, elementId, config, verbose) {
  ...
  _createClass(Html5QrcodeScanner, [{
    ...
    value: function render(qrCodeSuccessCallback, qrCodeErrorCallback) {
      ...
      var container = this.container.querySelector("#"+this.elementId);
      container.innerHTML = "";

      this.__createBasicLayout(container);

      this.html5Qrcode = new Html5Qrcode(this.container,this.__getScanRegionId(), this.verbose);
    }
    /**
    ...
    value: function clear() {
      ...
      var emptyHtmlContainer = function emptyHtmlContainer() {
        var mainContainer = _this4.container.querySelector("#"+_this4.elementId);
    ...
    value: function __createSectionControlPanel() {
      var $this = this;
      var section = this.container.querySelector("#"+this.__getDashboardSectionId());
    ...
    value: function __renderCameraSelection(cameras) {
      var $this = this;
      var scpCameraScanRegion = this.container.querySelector("#"+this.__getDashboardSectionCameraScanRegionId());
    ...
    value: function __setStatus(statusText, statusClass) {
      ...
      var statusSpan = this.container.querySelector("#"+this.__getStatusSpanId());
    ...
    value: function __resetHeaderMessage() {
      var messageDiv = this.container.querySelector("#"+this.__getHeaderMessageContainerId());
    ...
    value: function __insertCameraScanImageToScanRegion() {
      var $this = this;
      var qrCodeScanRegion = this.container.querySelector("#"+this.__getScanRegionId());
    ...
    value: function __getCameraScanRegion() {
      return this.container.querySelector("#"+this.__getDashboardSectionCameraScanRegionId());
    }
  }, {
    key: "__getFileScanRegion",
    value: function __getFileScanRegion() {
      return this.container.querySelector("#"+this.__getDashboardSectionFileScanRegionId());
    }
  }, {
    key: "__getFileScanInput",
    value: function __getFileScanInput() {
      return this.container.querySelector("#"+this.__getFileScanInputId());
    }
  }, {
    key: "__getDashboardSectionSwapLink",
    value: function __getDashboardSectionSwapLink() {
      return this.container.querySelector("#"+this.__getDashboardSectionSwapLinkId());
    } //#endregion
