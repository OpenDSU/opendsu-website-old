var QRCode = function (t) {
  ...
  var v = l, p = h((function (t, r) {
      ...
      r.getRowColCoords = function (t) {
        ...
        for (var e = [], n = r.getRowColCoords(t), o = n.length, a = 0; a < o; a++) for (var i = 0; i < o; i++) 0 === a && 0 === i || 0 === a && i === o - 1 || a === o - 1 && 0 === i || e.push([n[a], n[i]]);
        return e
      }
    })), w = (p.getRowColCoords, p.getPositions, o), m = function (t) {
      var r = w(t);
    ...
    }, B = new Uint8Array(512), C = new Uint8Array(256);
  !function () {
    for (var t = 1, r = 0; r < 255; r++) B[r] = t, C[t] = r, 256 & (t <<= 1) && (t ^= 285);
    for (var e = 255; e < 512; e++) B[e] = B[e - 255]
  }();
  var M = function (t) {
    return B[t]
  }, P = function (t, r) {
    return 0 === t || 0 === r ? 0 : B[C[t] + C[r]]
  }, R = h((function (t, r) {
    r.mul = function (t, r) {
      ...
      for (var e = new Uint8Array([1]), n = 0; n < t; n++) e = r.mul(e, new Uint8Array([1, M(n)]));
      return e
    }
  }));
  R.mul, R.mod, R.generateECPolynomial;
  ...
  var L = T, b = function (t) {
    ...
    F = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), S = new RegExp(x, "g"), D = new RegExp("[0-9]+", "g"),
    Y = new RegExp("[A-Z $%*+\\-./:]+", "g"), z = new RegExp("^" + U + "$"), _ = new RegExp("^[0-9]+$"),
    H = new RegExp("^[A-Z0-9 $%*+\\-./:]+$"), J = {
      KANJI: k, BYTE_KANJI: F, BYTE: S, NUMERIC: D, ALPHANUMERIC: Y, testKanji: function (t) {
        return z.test(t)
      ...
      r.NUMERIC = {id: "Numeric", bit: 1, ccBits: [10, 12, 14]}, r.ALPHANUMERIC = {
        ...
        bit: 8,
        ccBits: [8, 10, 12]
      }, r.MIXED = {bit: -1}, r.getCharCountIndicator = function (t, r) {
    ...
    O = (K.NUMERIC, K.ALPHANUMERIC, K.BYTE, K.KANJI, K.MIXED, K.getCharCountIndicator, K.getBestModeForData, K.isValid, h((function (t, r) {
      var e = i(7973);
    ...
    }))), Q = (O.getCapacity, O.getBestVersionForData, O.getEncodedBits, i(1335)), V = function (t, r) {
    ...
    r.fromArray = function (t) {
      ...
      for (var i = function (t, r) {
        ...
        for (var r = [], n = 0; n < t.length; n++) {
          ...
          switch (o.mode) {
            case K.NUMERIC:
              r.push([o, {data: o.data, mode: K.ALPHANUMERIC, length: o.length}, {
                data: o.data,
                mode: K.BYTE,
                length: o.length
              }]);
        ...
        return r
      }(o(t, s())), n), u = et.find_path(i.map, "start", "end"), f = [], h = 1; h < u.length - 1; h++) f.push(i.table[u[h]].node);
  ...
  function at(t, r, e) {
    ...
    return function (t, r, e) {
      for (var n = a(r), o = N(r, e), i = n - o, u = I(r, e), s = u - n % u, f = Math.floor(n / u), h = Math.floor(i / u), c = h + 1, g = f - h, d = new L(g), l = 0, v = new Array(u), p = new Array(u), w = 0, m = new Uint8Array(t.buffer), E = 0; E < u; E++) {
        var y = E < s ? h : c;
        v[E] = m.slice(l, l + y), p[E] = d.encode(v[E]), l += y, w = Math.max(w, y)
      }
      var A, B, C = new Uint8Array(n), M = 0;
      for (A = 0; A < w; A++) for (B = 0; B < u; B++) A < v[B].length && (C[M++] = v[B][A]);
      for (A = 0; A < g; A++) for (B = 0; B < u; B++) C[M++] = p[B][A];
      return C
    }(n, t, r)
  }
  ...
  function it(t, r, e, n) {
    var a;
    if (Array.isArray(t)) a = nt.fromArray(t); else {
  ...
  var ut = function (t, r) {
    ...
    r.getOptions = function (t) {
      ...
      for (var o = e.modules.size, a = e.modules.data, i = r.getScale(o, n), u = Math.floor((o + 2 * n.margin) * i), s = n.margin * i, f = [n.color.light, n.color.dark], h = 0; h < u; h++) for (var c = 0; c < u; c++) {
  ...
  })), ft = (st.getOptions, st.getScale, st.getImageWidth, st.qrToImageData, h((function (t, r) {
  ...
  var gt = function (t, r, e) {
    var n = st.getOptions(r), o = t.modules.size, a = t.modules.data, i = o + 2 * n.margin,
      ...
      s = "<path " + ht(n.color.dark, "stroke") + ' d="' + function (t, r, e) {
        ...
        return n
      }(a, o, n.margin) + '"/>', f = 'viewBox="0 0 ' + i + " " + i + '"',
  ...
  var lt = ut, vt = dt.bind(null, ft.render), pt = dt.bind(null, ft.renderToDataURL),
    wt = dt.bind(null, (function (t, r, e) {
      return gt(t, e)
    })), mt = {create: lt, toCanvas: vt, toDataURL: pt, toString: wt};
  return t.create = lt, t.default = mt, t.toCanvas = vt, t.toDataURL = pt, t.toString = wt, t
}({});
export {
  QRCode
}
